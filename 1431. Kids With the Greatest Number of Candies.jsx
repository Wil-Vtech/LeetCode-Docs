/* 431. Kids With the Greatest Number of Candies
...
var kidsWithCandies = function(candies, extraCandies) {
    //make max candy in the array value this now sort/find
    let mostCandy = Math.max(...candies);
    let result = []

    //compare the value if its candies + extra candies then 
    for(let i = 0; i < candies.length; i++){
    result.push(candies[i] + extraCandies >= mostCandy)//conditional truthy/falsy value
    }
    return result
